...
class MutedTest:
    def execution_test(self, stream: StringIO) -> None:
        make_muted = muted()
    ...
    def str_test(self, stream: StringIO) -> None:
    ...
    def none_test(self, stream: StringIO) -> None:
    ...
    def logger_test(self, stream: StringIO) -> None:
    ...
    def mixed_test(self, stream: StringIO) -> None:
