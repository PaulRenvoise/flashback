...
class EncryptedFileTest:
    ...
    def read_and_write_test(self) -> None:
        encrypted_file = EncryptedFile(
            FILE_PATH,
            KEY_PATH,
        )
    ...
    def read_and_write_with_custom_serializer_test(self) -> None:
        encrypted_file = EncryptedFile(
            FILE_PATH,
            KEY_PATH,
        )
    ...
    def read_and_write_with_no_serializer_test(self) -> None:
        encrypted_file = EncryptedFile(
            FILE_PATH,
            KEY_PATH,
        )
    ...
    def read_and_write_with_key_in_env_test(self) -> None:
        encrypted_file = EncryptedFile(
            FILE_PATH,
            KEY_PATH,
        )
    ...
    def read_without_key_test(self) -> None:
        encrypted_file = EncryptedFile(
            FILE_PATH,
            KEY_PATH,
        )
    ...
    def read_without_file_test(self) -> None:
        encrypted_file = EncryptedFile(
            FILE_PATH,
            KEY_PATH,
        )
