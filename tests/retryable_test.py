...
class RetryableTest:
    def without_exception_test(self) -> None:
    ...
    def with_exception_test(self) -> None:
    ...
    def with_plateau_after_test(self) -> None:
    ...
    def with_reset_after_test(self) -> None:
    ...
    def with_max_retries_test(self) -> None:
