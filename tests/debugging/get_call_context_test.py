...
class GetCallContextTest:
    def one_line_call_test(self) -> None:
    ...
    def one_line_call_with_size_test(self) -> None:
        frameinfo = dummy_function()
    ...
    def multiline_call_test(self) -> None:
