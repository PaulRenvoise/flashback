...
class CallerTest:
    def execution_test(self, output: StringIO) -> None:
    ...
    def execution_with_depth_test(self, output: StringIO) -> None:
    ...
    def execution_with_context_test(self, output: StringIO) -> None:
    ...
    def no_frame_test(self, mocked_currentframe: Mock, output: StringIO) -> None:
    ...
    def no_context_test(self, mocked_findsource: Mock, output: StringIO) -> None:
    ...
    def no_callable_test(self, mocked_get_callable: Mock, output: StringIO) -> None:
