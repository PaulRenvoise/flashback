...
class DeprecatedTest:
    ...
    def message_with_since_and_until_and_reason_test(self) -> None:
        spy_func = Mock()
    ...
    def message_with_since_and_reason_test(self) -> None:
        spy_func = Mock()
    ...
    def message_with_until_and_reason_test(self) -> None:
        spy_func = Mock()
    ...
    def message_with_since_and_until_test(self) -> None:
        spy_func = Mock()
    ...
    def message_with_since_test(self) -> None:
        spy_func = Mock()
    ...
    def message_with_until_test(self) -> None:
        spy_func = Mock()
    ...
    def message_with_reason_test(self) -> None:
        spy_func = Mock()
