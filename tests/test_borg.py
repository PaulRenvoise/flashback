...
def dummy_func(value, **kwargs) -> dict[str, t.Any]:
    response = {"key": value}
...
def _clean_up_shared_state() -> None:
    Borg._shared_state = {}  # noqa: SLF001


class TestBorg:
    def test_borg_functionnal(self) -> None:
        borg_1 = Borg()
        borg_2 = Borg()
    ...
    def test_borg_empty_dict(self) -> None:
        borg = Borg()

        assert not borg.__dict__

    def test_assign_attribute(self) -> None:
        borg = Borg()
    ...
    def test_assign_attribute_override(self) -> None:
        borg = Borg()
    ...
    def test_assign_attribute_multiple(self) -> None:
        borg = Borg()
    ...
    def test_assign_attributes_override(self) -> None:
        borg = Borg()
