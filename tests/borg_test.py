...
class BorgTest:
    def functionnal_test(self) -> None:
        borg_1 = Borg()
        borg_2 = Borg()
    ...
    def empty_dict_test(self) -> None:
        borg = Borg()

        assert not borg.__dict__

    class AssignAttributeTest:
    ...
    class AssignAttributesTest:
        ...
        def empty_callable_parameters_test(self) -> None:
            borg = Borg()
