...
PLURAL_RULES = [
  ...
  (
    ...
    (r"(ahr|akt|arn|bot|chs|ehl|eil|eim|eis|ekt|ell|erd|erk|ern|ert|ess|est|etz|eug|ekt|eur|ich|ick|ieb|eif|weg"
     "|ohr|ord|rot|tag|nkt|mpf|nat|nst|off|oot|lar|ruf|rzt|tiv|ieg|iel|iet|iff|ilm|ing|iss|itt|itz)$", r"\1e", None),
